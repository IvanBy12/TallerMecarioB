  ...
  properties: {
    workshop: {
      ...
      properties: {
        ...
        timezone: textProperty(64),
        currency: textProperty(3),
      },
    },
    primaryLocation: {
      type: 'object',
...
export function registerOnboardingRoutes(
  ...
  app.post('/api/v1/onboarding/workshops', {
    bodyLimit: 16 * 1024,
    config: { rateLimit: options.rateLimit ?? { max: 10, timeWindow: '1 minute' } },
    ...
    const identityContext = getIdentityOnlyRequestContext(request);
