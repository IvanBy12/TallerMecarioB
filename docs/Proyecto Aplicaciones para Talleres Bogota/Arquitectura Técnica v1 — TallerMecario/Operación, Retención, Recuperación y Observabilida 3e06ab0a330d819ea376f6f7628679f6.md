...
- Threat model: los GUC son contexto fijado por la aplicación, no prueba criptográfica. SQL raw con credencial runtime comprometida puede establecer GUC arbitrarios o tomar advisory keys deterministas; queda fuera de esta garantía (INFO). No se añadió `lock_timeout`. El Quality Gate final de Sprint 1 y la deuda CI siguen abiertos.
...
- E2E real contra Resend: **pendiente** (no ejecutado en S1-04).
